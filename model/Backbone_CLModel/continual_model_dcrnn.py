...
class ContinualModel(nn.Module):
    ...
    def forward(self, x, labels=None, batches_seen=0, aug1=None, aug2=None, lamda=None, buffer_x=None):
        if buffer_x is None:
            orginal_mixup = x
        else:
        ...
        # print('original mixup shared', orginal_mixup_shared.shape)
        
        net_out = self.net_decoder(orginal_mixup_shared, labels, batches_seen)
